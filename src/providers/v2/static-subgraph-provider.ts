...
const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  // HookSwap chains (v2 deployed by HookSwap; see util/chains.ts V2_SUPPORTED)
  [ChainId.HYPEREVM]: [
    WRAPPED_NATIVE_CURRENCY[ChainId.HYPEREVM]!,
    USDT0_HYPEREVM,
  ],
  [ChainId.ROBINHOOD]: [
  ...
  [ChainId.MEGAETH]: [
    WRAPPED_NATIVE_CURRENCY[ChainId.MEGAETH]!,
    USDM_MEGAETH,
    USDE_MEGAETH,
  ],
